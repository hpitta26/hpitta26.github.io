...
const Navbar = () => {
  ...
  return (
    <nav 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-400 border-b-[1px] ${
        scrolled ? 'bg-[#1a0836] backdrop-blur-sm border-[#220f3c]' : 'bg-transparent border-transparent'
      }`}
    >
